...
namespace EdgeMultiplay {
    /// <summary>
    /// ObserverableView is added  to Observered objects, holding the reference to the observerable owner and the observerable index in in the observer.observerable list
    /// </summary>
